...
model boatTest
  ...
  // spanker
  SailBoatModel.Components.Instances.MainSail mainsail(r_COL = {0, 0, 0}, heightDirection = {0, 1, 0}, sailWidth = 0.01, r_0.fixed = false, v_0.fixed = true, r_0.start = {0, 0, 0}, v_0.start = {0, 0, 0}, color = {0, 0, 0}, m = 10, sailLength = 1, angles_fixed = true) annotation(Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  // Sensor
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyBox raft(r = {3, 0, 0}, r_shape = {-0.5, 0, 0}, widthDirection = {0, 0, 1}, width = 1, height = 0.01, r_0.fixed = true, v_0.fixed = true, angles_fixed = false, w_0_fixed = false, z_0_fixed = false, a_0.fixed = false, v_0.start = {0, 0, 0}, r_0.start = {0, 0, 0}) annotation(Placement(visible = true, transformation(origin = {13.248, -65.94}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  // Servo input
  ...
  Instances.Spanker spanker(r_COL = {0, 0, 0}, heightDirection = {0, 1, 0}, sailWidth = 0.01, r_0.fixed = false, v_0.fixed = true, r_0.start = {0, 0, 0}, v_0.start = {0, 0, 0}, color = {0, 0, 0}, m = 10, sailLength = 0.6) annotation(Placement(visible = true, transformation(origin = {70, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation1(r = {1, 0, 0}) annotation(Placement(visible = true, transformation(origin = {33.13, -18.406}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(fixedTranslation1.frame_b, spanker.frame_a) annotation(Line(visible = true, origin = {61.043, -15.604}, points = {{-17.913, -2.802}, {8.957, -2.802}, {8.957, 5.604}}, color = {95, 95, 95}));
end boatTest;

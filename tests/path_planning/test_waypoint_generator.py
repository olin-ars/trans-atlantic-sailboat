...
class TestWaypointGeneration(unittest.TestCase):
    ...
    def test_waypoint_generation(self):
        ...
        self.assertListEqual(make_waypoints(test_1_input), test_1_output)

        test_2_input = [(0, 0), (1, 1), (2, 2), (3, 3)]
        test_2_output = [(3, 3)]
        self.assertListEqual(make_waypoints(test_2_input), test_2_output)

        test_3_input = [(0, 0), (1, 0), (2, 0), (3, 0)]
        test_3_output = [(3, 0)]
        self.assertListEqual(make_waypoints(test_3_input), test_3_output)
